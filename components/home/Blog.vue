<template>
  <section class="flex flex-col justify-center sm:px-6">
      ...
      <div class="w-full max-w-full mb-8 sm:w-1/2 px-4 lg:w-1/4 flex flex-col">
        ...
        <div class="flex flex-grow">
          ...
          <div class="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 text">
            <div>
              <a href="#" class="block mb-4 text-2xl font-black leading-tight hover:underline hover:text-primary">
                What Zombies Can Teach You About Food
              </a>
              <p class="mb-4">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nulla delectus corporis commodi aperiam, amet
                cupiditate? Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatum, explicabo! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repellat, natus.
              </p>
            </div>
            <div>
              <a href="#"
                class="inline-block pb-1 mt-2 text-base font-black text-primary uppercase border-b border-transparent hover:border-primary transition-colors">Read
                More -></a>
            </div>
          </div>
        </div>
