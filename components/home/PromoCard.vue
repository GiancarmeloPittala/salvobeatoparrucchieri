  ...
  <div class="container m-auto px-6 md:px-12 lg:px-20">
    <div class="m-auto text-center lg:w-8/12 xl:w-7/12">
      <h2 class="text-2xl text-pink-900 font-bold md:text-4xl">
        Approfitta dei nostri pacchetti promozionali
      </h2>
    </div>
    <div class="mt-12 m-auto -space-y-4 items-center justify-center md:flex md:space-y-0 md:-space-x-4 xl:w-10/12">
        ...
        <div class="relative p-6 space-y-6 lg:p-8">
          <div class="relative flex justify-around">
            <div class="flex items-end">
              <span class="text-8xl text-black font-bold leading-0">35</span>
              <div class="pb-2">
                <span class="block text-2xl text-black font-bold">%</span>
                <span class="block text-xl text-primary font-bold">Off</span>
              </div>
            </div>
          </div>
          <ul role="list" class="w-max space-y-4 py-6 m-auto text-gray-600">
            <li class="space-x-2">
              <span class="text-primary font-semibold">&check;</span>
          ...
          <p class="flex items-center justify-center space-x-4 text-lg text-gray-600 text-center">
            ...
            <a href="tel:+24300" class="flex space-x-2 items-center text-primary">
          ...
          <button type="submit" title="Submit"
            class="block w-full py-3 px-6 text-center rounded-xl transition bg-primary hover:bg-purple-700 active:bg-purple-800 focus:bg-indigo-600">
      ...
      <div class="relative group md:w-6/12 lg:w-7/12">
        ...
        <div class="relative p-6 pt-16 md:p-8 md:pl-12 md:rounded-r-2xl lg:pl-20 lg:p-16">
          ...
          <p class="text-black">Team can be any size, and you can add or switch members as needed. Companies using
            our platform include:</p>
          <div class="mt-6 flex justify-between gap-6">
            <img class="w-16 lg:w-24"
              src="https://tailus.io/sources/blocks/organization/preview/images/clients/airbnb.svg" loading="lazy"
              alt="airbnb">
            <img class="w-8 lg:w-16"
              src="https://tailus.io/sources/blocks/organization/preview/images/clients/bissell.svg" loading="lazy"
              alt="bissell">
            <img class="w-6 lg:w-12" src="https://tailus.io/sources/blocks/organization/preview/images/clients/ge.svg"
              loading="lazy" alt="ge">
            <img class="w-20 lg:w-28"
              src="https://tailus.io/sources/blocks/organization/preview/images/clients/microsoft.svg" loading="lazy"
              alt="microsoft">
          </div>
        </div>
      </div>
